...
export default function GlobalAdminProfilePage() {
  ...
  const [phone, setPhone] = useState('+380 44 000 00 00');
    ...
    <div className="mx-auto max-w-xl space-y-6">
      ...
      <AppCard>
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center">
          <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-green-600 to-green-900 text-2xl font-bold text-white shadow-lg">
            {avatarUrl ? (
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-xs font-medium text-green-800">Роль: глобальний адміністратор</p>
            <input
              ref={fileInputRef}
              type="file"
              accept="image/*"
